...
import modalPage  from './../modal/modalPage.js';
...
async function leaveHandler(membershipId, teamId) {
    let modalResult = await modalPage.createModal('Are you sure you want to leave?');
...
async function getView(context, next) {
    ...
    let allMembershipsPromise =  _membersService.getMembersForTeamWithUser(teamId);
