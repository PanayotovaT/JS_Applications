...
async function getOwnLikesByMovieId(id, user) {
...
function createMovieCard(movie, likes, ownLike) {
    ...
    const controls = e('div', { className: 'col-md-4 text-center' }, e('h3', { className: "my-3" }, 'Movie Description'), e('p', {}, movie.description))
    ...
    const likesSpan = e('a', { className: 'enrolled-span' }, likes + ' like' + (likes == 1 ? '' : 's'));
